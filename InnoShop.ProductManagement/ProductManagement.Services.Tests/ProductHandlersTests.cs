    ...
    public class ProductHandlersTests
    {
        ...
        public async Task<ProductManagementDBContext> InitMockDB()
        {
            ...
            foreach (var productStatusDto in productStatusDTOs)
            {
                ...
                var handlerAddProdStat = new AddProductStatusHandler(dbContext);
            ...
            foreach(var productDTO in productDTOs)
            {
                ...
                var handler = new AddProductHandler(dbContext);
        ...
        public async void AddProductHandler()
        {
            ...
            var handlerProdStat = new AddProductStatusHandler(dbContext);
        ...
        public async void DeleteProductByIdHandler()
        {
            ...
            var handler = new DeleteProductByIdHandler(dbContext);
        ...
        public async void TakeProductDTOByIdHandler()
        {
            ...
            var handler = new TakeProductDTOByIdHandler(dbContext);
        ...
        public async void TakeProductDTOListHandler()
        {
            ...
            var handler = new TakeProductDTOListHandler(dbContext);
        ...
        public async void ChangeProductStatusesOfProductsByUserIdHandler()
        {
            ...
            var handler = new ChangeProductStatusesOfProductsByUserIdHandler(dbContext);
        ...
        public async void ChangeProductStatusOfProductHandler()
        {
            ...
            var productId = (await dbContext.Products.AsNoTracking().FirstOrDefaultAsync(p => p.Title == "Asus")).Id;
            ...
            var handler = new ChangeProductStatusOfProductHandler(dbContext);
            ...
            //Assert
            Assert.True(result.Flag == true
                    && (await dbContext.Products.FirstOrDefaultAsync(p=> p.Title =="Asus")).ProductStatusId == dProductStatusId);
        ...
        public async void TakeProductDTOListByUserIdHandler()
        {
            ...
            var handler = new TakeProductDTOListByUserIdHandler(dbContext);
        ...
        public async void TakeSearchedProductDTOListHandler()
        {
            ...
            var handler = new TakeSearchedProductDTOListHandler(dbContext);
        ...
        public async void TakeFilteredProductDTOListHandler()
        {
            ...
            var handler = new TakeFilteredProductDTOListHandler(dbContext);
